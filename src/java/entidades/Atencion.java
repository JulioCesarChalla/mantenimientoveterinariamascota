...
public class Atencion  implements java.io.Serializable {
    ...
    public Atencion(Mascotaporcliente mascotaporcliente, Personal personal, Tipoatencion tipoatencion, Date fechaAtencion, String diagnostico) {
    ...
    public Atencion(Mascotaporcliente mascotaporcliente, Personal personal, Tipoatencion tipoatencion, Date fechaAtencion, String diagnostico, Date horaAtencion) {
       this.mascotaporcliente = mascotaporcliente;
       this.personal = personal;
       this.tipoatencion = tipoatencion;
       this.fechaAtencion = fechaAtencion;
